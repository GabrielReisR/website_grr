...
```{r Estimate bootnet object, warning=FALSE, message=FALSE}
...
```{r Plotting network, warning=FALSE, message=FALSE}
plot(network, 
     layout = "spring",
     groups = traits,
...
```{r Stability of edge weights, warning=FALSE, message=FALSE}
...
```{r Checking centrality measures, message=FALSE, warning=FALSE}
...
```{r Creating case-dropping bootstraps, message=FALSE, warning=FALSE}
...
```{r Checking corStability results, message=FALSE, warning=FALSE}
...
```{r Checking if N1 is different than N3, warning=FALSE, message=FALSE}
...
```{r Checking if N1--N2 is different from N1--N5, warning=FALSE, message=FALSE}
differenceTest(bootnet_nonpar,
               "N1--N2",
               "N1--N5",
               measure = "edge")
