...
2. [Graphing options](/blog/2021-10-01-nct/#graphing-options)
3. [Comparing general network invariance](/blog/2021-10-01-nct/#comparing-general-network-invariance)
4. [Comparing general strength invariance](/blog/2021-10-01-nct/#comparing-general-strength-invariance)
5. [Comparing difference in specific edges](/blog/2021-10-01-nct/#comparing-difference-in-specific-edges)
5. [Reporting our findings](/blog/2021-10-01-nct/#reporting-our-findings)
...
```{r Summary of both networks, warning=FALSE, message=FALSE}
...
```{r Fix parameters, message=FALSE, warning=FALSE}
...
```{r Male network, message=FALSE, warning=FALSE}
plot(network_male, 
     layout = net_layout,
     maximum = max_value,
     groups = traits,
...
```{r Female network, message=FALSE, warning=FALSE}
plot(network_female, 
     layout = net_layout,
     maximum = max_value,
     groups = traits,
